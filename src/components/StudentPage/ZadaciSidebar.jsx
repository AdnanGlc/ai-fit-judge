...
const ZadaciSidebar = () => {
  return (
    <div className="bg-white w-[15%] h-[85%] m-5 rounded-md pl-[1.5%] pt-4">
      <p>Zadaci:</p>
      <input
      ...
      <ul className="border-slate-500 border-2 w-[90%] rounded-md h-[85%] bg-slate-100">
        ...
        <li className="m-2 flex space-x-[40%] bg-slate-200 pl-2 rounded-md hover:opacity-70">
          <button>Zadatak 2</button>
          <div className="w-3 h-3 bg-red-500 mt-[6px] rounded-full"></div>
        </li>
        <li className="m-2 flex space-x-[40%] bg-slate-200 pl-2 rounded-md hover:opacity-70">
          <button>Zadatak 3</button>
          <div className="w-3 h-3 bg-gray-500 mt-[6px] rounded-full"></div>
        </li>
        <li className="m-2 flex space-x-[40%] bg-slate-200 pl-2 rounded-md hover:opacity-70">
          <button>Zadatak 4</button>
          <div className="w-3 h-3 bg-gray-500 mt-[6px] rounded-full"></div>
        </li>
      </ul>
    </div>
